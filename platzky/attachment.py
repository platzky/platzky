"""Attachment class for file attachments in notifications.

This module provides the Attachment class for validated file attachments.
...
class Attachment:
    ...
    def from_file(
        ...
        if effective_max_size > 0 and file_size > effective_max_size:
            raise AttachmentSizeError(
                _format_size_error(path.name, effective_max_size, file_size)
            )
